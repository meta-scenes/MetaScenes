...
def quary_matrix_by_inst(joint_matrix_all, one_scan, inst_id):
    ...
    if inst_id in joint_matrix_all:
        return joint_matrix_all[inst_id][inst_id]
    else:
        for src_inst_id in joint_matrix_all:
            if inst_id in joint_matrix_all[src_inst_id]:
                return joint_matrix_all[src_inst_id][inst_id]
