...
### MetaScenes Dataset
See [DATA.md](https://github.com/yuhuangyue/MetaScenes/blob/main/dataset/DATA.md) for detailed instructions on data download, processing, visualization.

Fill out the [form](https://forms.gle/k94RWbdoQ1KrLZpF7) for the download!

### MetaScenes Preprocessing
...
See [PREPROCESS.md](https://github.com/yuhuangyue/MetaScenes/blob/main/preprocess/PREPROCESS.md) for detailed instructions for setting up the environment, running each component, and understanding the output generated by each process.
...
See [MODEL.md](https://github.com/yuhuangyue/MetaScenes/blob/main/Scan2Sim/MODEL.md) for the inventory of available checkpoints and detailed instructions on training and testing 
